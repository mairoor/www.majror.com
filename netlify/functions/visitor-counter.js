// Netlify Function لتحديث عداد الزوار على GitHub
...
exports.handler = async (event, context) => {
    ...
    try {
        const filePath = '/contents/visitor-count.json';
        let currentCount = 0;
        let fileSha = null;
        ...
        if (method === 'POST') {
            // زيادة العدد
            currentCount += 1;
            console.log(`➕ تم زيادة العدد إلى: ${currentCount}`);
